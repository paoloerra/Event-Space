...
public class ProgettoEventiApplication {
	...
	CommandLineRunner init(UserRepositories u,EventRepositories e,RoleRepositories r) {
		return args->{
			...
			Event event1=new Event("Evento1",date,"Evento1 descrizione evento", "assets/images/event1.jpg","15:00","Napoli,piazza plebiscito","Sport", "event1.jpg");
			Event event2=new Event("Evento2",date,"Evento2"+ "descrizione evento", "assets/images/event_3.jpg","16:00","Salerno","Sport" , "event_3.jpg");
			Event event3=new Event("Evento3",date,"Evento3"+ "descrizione evento", "assets/images/event_5.jpg","16:00","Avellino","Sport", "event_5.jpg");
			Event event4=new Event("Evento4",date,"Evento4"+ "descrizione evento", "assets/images/event_4.jpg","16:00","Avellino","Music", "event_4.jpg");
